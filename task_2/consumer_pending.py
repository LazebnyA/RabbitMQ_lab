...
def main():
    ...
    channel.queue_bind(exchange='payment_logs', queue=queue_name, routing_key='failure')
    channel.queue_bind(exchange='payment_logs', queue=queue_name, routing_key='pending')
